...
const UnApprovedPost = () => {
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            try {
                const res = await axios.get(`http://localhost:7485/api/v1/get-Listing-un`);
    ...
    const handleApprove = async (postId) => {
        try { 
            await axios.put(`http://localhost:7485/api/v1/admin-approve-post/${postId}`);
    ...
    const handleDelete = async (postId) => {
        try {
            await axios.delete(`http://localhost:7485/api/v1/delete-listing/${postId}`);
