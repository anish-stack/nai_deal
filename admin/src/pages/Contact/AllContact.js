...
const AllContact = () => {
    ...
    const fetchContacts = async () => {
        try {
            const { data } = await axios.get("https://www.api.naideal.com/api/v1/Other/get-contacts");
            setContacts(data);
        } catch (error) {
    ...
    const deleteContact = async (id) => {
        try {
            await axios.delete(`https://www.api.naideal.com/api/v1/Other/delete-contacts/${id}`);
