...
const AllCity = () => {
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            await axios.post('https://www.api.naideal.com/api/v1/admin-create-city', formData, {
    ...
    const handleEdit = async (e) => {
        ...
        try {
            setIsSubmitting(true);
            await axios.post(`https://www.api.naideal.com/api/v1/admin-update-city/${selectedCityId}`, formData, {
                headers: { 'Content-Type': 'multipart/form-data' }
            });
    ...
    const handleDelete = async (id) => {
        ...
        try {
            setIsSubmitting(true);
            await axios.delete(`https://www.api.naideal.com/api/v1/admin-delete-city/${id}`);
            await fetchCities();
