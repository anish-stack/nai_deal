  ...
  const { userName } = useParams();
      ...
      const fetchData = async () => {
          try {
              ...
              const filteredShop = data?.filter(item => item?.ShopId?.UserName === userName);
              const findShop = data?.find(item => item?.ShopId?.UserName === userName);
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          ...
                          <div className="flex items-center gap-4">
                              ...
                              <div>
                                  ...
                                  <a href={`tel:${ShopId?.ContactNumber}`} className="text-gray-600">{ShopId?.ContactNumber
                                                ? `${ShopId.ContactNumber.slice(0, 2)}******${ShopId.ContactNumber.slice(-2)}`
                                                : ""}</a>
                              </div>
                          </div>
